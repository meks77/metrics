 ...
 * microprofiles standard, the class is named HistogramSummary, while it uses Prometheus Summary.
 */
@Interceptor
@Priority(Interceptor.Priority.APPLICATION)
@MonitorDurationHistogramSummary
public class MonitorDurationHistogramSummaryInterceptor extends AbstractInterceptor {
